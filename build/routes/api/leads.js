...
leads_routes.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name, imgLocation, lead, width, height, resizedFile;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, Sharp_1.default)(imgLocation, width, height, name)];
            case 1:
                resizedFile = _a.sent();
